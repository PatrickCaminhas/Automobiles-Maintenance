    ...
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="col-md-4 border p-4">
            ...
            <form action="../controllers/clienteController.php?funcao=cadastrarCliente" method="post">
                ...
                <input type="tel" id="telefone" name="telefone" required placeholder="Seu telefone celular"
                    class="form-control" minlength="11" maxlength="11"><br>

                <label for="senha">Senha:</label>
                <input type="password" id="senha" name="senha" required placeholder="Mínimo 6 e máximo 15 caracteres"
                    class="form-control" minlength="6" maxlength="15"><br>

                <input type="submit" value="Cadastrar" class="fw-medium btn btn-primary mb-3">
                <input type="button" value="Voltar" class="fw-medium btn btn-primary mb-3"
