        ...
        <div class="col-md-4 border p-4"> <!-- Adicione a classe border e a classe de espaçamento p-4 -->
            ...
            <form action="../controllers/login.php" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" id="login" name="login" required placeholder="Seu e-mail ou celular"
                        class="form-control"><br> <!-- Adicione a classe form-control -->
                    <label for="senha">Senha:</label>
                    <input type="password" id="senha" name="senha" required placeholder="Sua senha"
                        class="form-control"><br> <!-- Adicione a classe form-control -->
                    <input type="submit" value="Entrar" class="fw-medium btn btn-primary">
                    <!-- Adicione a classe btn btn-primary para estilizar o botão -->
